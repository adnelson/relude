...
")
let getOk: 'a 'e. t<'a, 'e> => option<'a> = x =>
  switch x {
  | Ok(a) => Some(a)
  | Error(_) => None
  }
...
")
let getError: 'a 'e. t<'a, 'e> => option<'e> = x =>
  switch x {
  | Ok(_) => None
  | Error(e) => Some(e)
  }
...
")
let fold: 'a 'e 'c. ('e => 'c, 'a => 'c, t<'a, 'e>) => 'c = (ec, ac, r) =>
  switch r {
  | Ok(a) => ac(a)
  | Error(e) => ec(e)
  }
...
")
let getOrElse: 'a 'e. ('a, t<'a, 'e>) => 'a = (default, fa) =>
  switch fa {
  | Ok(a) => a
  | Error(_) => default
  }
...
")
let getOrElseBy: 'a 'e. ('e => 'a, t<'a, 'e>) => 'a = (fn, fa) =>
  switch fa {
  | Ok(a) => a
  | Error(e) => fn(e)
  }
...
")
let getOrElseLazy: 'a 'e. (unit => 'a, t<'a, 'e>) => 'a = (getDefault, fa) =>
  switch fa {
  | Ok(a) => a
  | Error(_) => getDefault()
  }
...
")
let getErrorOrElse: 'a 'e. ('e, t<'a, 'e>) => 'e = (default, fa) =>
  switch fa {
  | Ok(_) => default
  | Error(e) => e
  }
...
")
let getErrorOrElseBy: 'a 'e. ('a => 'e, t<'a, 'e>) => 'e = (fn, fa) =>
  switch fa {
  | Ok(a) => fn(a)
  | Error(e) => e
  }
...
")
let mapError: 'a 'e1 'e2. ('e1 => 'e2, t<'a, 'e1>) => t<'a, 'e2> = (f, ra) =>
  switch ra {
  | Ok(_) as res => res
  | Error(e) => Error(f(e))
  }
...
")
let bimap: 'a 'b 'e1 'e2. ('a => 'b, 'e1 => 'e2, t<'a, 'e1>) => t<'b, 'e2> = (mapA, mapE, result) =>
  switch result {
  | Ok(a) => Ok(mapA(a))
...
")
let tap: 'a 'e. ('a => unit, t<'a, 'e>) => t<'a, 'e> = (f, ra) => {
  switch ra {
  | Ok(a) => f(a)
  | Error(_) => ()
  }
...
")
let tapError: 'a 'e. ('e => unit, t<'a, 'e>) => t<'a, 'e> = (f, ra) => {
  switch ra {
  | Ok(_) => ()
  | Error(e) => f(e)
  }
...
")
let flatMap: 'a 'b 'e. ('a => t<'b, 'e>, t<'a, 'e>) => t<'b, 'e> = (f, fa) => bind(fa, f)
...
the [Error].
")
let flatten: 'a 'e. t<t<'a, 'e>, 'e> => t<'a, 'e> = mma => bind(mma, a => a)
...
")
let align: 'a 'b 'e. (t<'a, 'e>, t<'b, 'e>) => t<Relude_Ior_Type.t<'a, 'b>, 'e> = (fa, fb) =>
  switch (fa, fb) {
...
")
let catchError: 'a 'e1 'e2. ('e1 => t<'a, 'e2>, t<'a, 'e1>) => t<'a, 'e2> = (f, fa) =>
  switch fa {
  | Ok(_) as res => res
  | Error(e) => f(e)
  }
...
been handled.
")
let handleError: 'a 'e. ('e => 'a, t<'a, 'e>) => t<'a, Relude_Void.t> = (eToA, fa) =>
  switch fa {
  | Ok(_) as res => res
  | Error(e) => Ok(eToA(e))
  }
...
")
let fromOption: 'a 'e. ('e, option<'a>) => t<'a, 'e> = (defaultError, opt) =>
  switch opt {
  | Some(a) => Ok(a)
...
")
let fromOptionLazy: 'a 'e. (unit => 'e, option<'a>) => t<'a, 'e> = (getError, opt) =>
  switch opt {
  | Some(a) => Ok(a)
  | None => Error(getError())
  }
...
")
let toValidationNel: t<'a, 'e> => Relude_Validation.t<'a, Relude_NonEmpty.List.t<'e>> = x =>
  switch x {
  | Ok(value) => Relude_Validation.VOk(value)
  | Error(error) => Relude_Validation.VError(Relude_NonEmpty.List.pure(error))
  }
...
")
let toValidationNea: t<'a, 'e> => Relude_Validation.t<'a, Relude_NonEmpty.Array.t<'e>> = x =>
  switch x {
  | Ok(value) => Relude_Validation.VOk(value)
  | Error(error) => Relude_Validation.VError(Relude_NonEmpty.Array.pure(error))
  }
...
@ocaml.doc("�\"(!H!O�#(!H!W@������i@@ ��j@@ �A�@@�����%Error��2(!H!Y�3(!H!^@��@��7(!H!_�8(!H!`@@��:(!H!Y�;(!H!a@@@��=(!H!L�>(!H!b@@@����%Error��E(!H!f�F(!H!k@��������!e��Q(!H!l�R(!H!m@��T(!H!l�U(!H!m@@@��W(!H!k�X(!H!n@@��Z(!H!f�[(!H!n@���n���@@ ���@@ �A�@@@��d$ � ��e)!o!t@@��g# � ��h)!o!t@@��j# � ��k)!o!t@@@��m 6 6�n)!o!t@@��p 6 6�q)!o!tA���@�������'andThen��~+!w!{�+!w!�@���+!w!{��+!w!�@@����!a���A@ ���A@ �A��!b���A@ ���A@ �A��!c��A@ ��A@ �A��!e��
A@ ��A@ �A@��@����!t���-!�!���-!�!�@���@��!a���-!�!���-!�!�@@��!b���-!�!���-!�!�@@���-!�!���-!�!�@@���!e���-!�!���-!�!�@@@���-!�!���-!�!�@@��@����!t���-!�!���-!�!�@���@��!b���-!�!���-!�!�@@��!c���-!�!���-!�!�@@���-!�!���-!�!�@@���!e���-!�!���-!�!�@@@���-!�!���-!�!�@@����!t���-!�!���-!�!�@���@��!a���-!�!���-!�!�@@��!c���-!�!���-!�!�@@��-!�!��-!�!�@@���!e��-!�!��	-!�!�@@@��-!�!��-!�!�@@��-!�!��-!�!�@@��-!�!��-!�!�@@��U@@ ��V@@ �A@��+!w!{�/!�")
module WithError = (E: TYPE) => {
  ...
  module MonadThrow: Relude_Interface.MONAD_THROW with type t<'a> = t<'a> and type e = E.t = {
    include Monad
    type e = E.t
  ...
  module MonadError: Relude_Interface.MONAD_ERROR with type t<'a> = t<'a> and type e = E.t = {
    include MonadThrow
  ...
  module WithApplicative = (A: APPLICATIVE) => {
    ...
    include Relude_Extensions_Bitraversable.BitraversableExtensions(Bitraversable)
  }
